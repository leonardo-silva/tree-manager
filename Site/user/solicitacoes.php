        ...
        <div class=" col-md-9 mt-3 table table-responsive">
            <table class="table table-striped  ">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>01</th>
                        <th>brenovambaster5@gmail.com</th>
                        <th>13/09/2019</th>

                        <th><a href="verSolicitacao.php">Ver</a></th>
                        <th>
                            <div class="custom-control custom-checkbox ">
                                <input type="checkbox" class="custom-control-input" disabled checked id="situacao">
                    ...
                    <tr>
                        <th>02</th>
                        <th>teste01@gmail.com</th>
                        <th>13/09/2019</th>

                        <th><a href="verSolicitacao.php">Ver</a></th>
                        <th>
                            <div class="custom-control custom-checkbox ">
                                <input type="checkbox" class="custom-control-input" disabled checked id="2">
                                <label class="custom-control-label " for="2">Lida</label>
                            </div>
                        </th>
                    </tr>
                </tbody>
